 ...
 * to the #ClutterActor at those coordinates. For historical reasons the
 * result is the actor which would be at the specified location on the next
 * redraw, and is not that which was there on the previous redraw (currently
 * on screen). This allows the function to perform chronologically correctly
 * after any queued changes to the scene, and even if nothing has been drawn.
 *
