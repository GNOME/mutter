...
G_DECLARE_FINAL_TYPE (MetaFramebufferKms, meta_framebuffer_kms, META, FRAMEBUFFER_KMS, MetaFramebuffer)

MetaFramebufferKms*
meta_framebuffer_kms_new_from_gbm (MetaGpuKms         *gpu_kms,
                                   struct gbm_surface *gbm_surface,
                                   gboolean            use_modifiers);

MetaFramebufferKms*
meta_framebuffer_kms_new_from_dumb (MetaGpuKms *gpu_kms,
                                    uint32_t    dumb_fb_id);

void meta_framebuffer_kms_set_gpu (MetaFramebufferKms *fb_kms,
                                   MetaGpuKms         *gpu_kms);
