              ...
              uint8_t                       *data)
{
  ...
  window_src->crop_width = cr_width;
  window_src->crop_height = cr_height;
...
meta_screen_cast_window_stream_src_enable (MetaScreenCastStreamSrc *src)
{
  ...
  window_src->crop_width = window->rect.width;
  window_src->crop_height = window->rect.height;
                                                 ...
                                                 uint8_t                 *data)
{
  ...
  /* TODO: Update pipewire VideoCrop based on crop_width/crop_height */
}
