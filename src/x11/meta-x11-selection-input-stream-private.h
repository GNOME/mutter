...
#ifndef __META_X11_SELECTION_INPUT_STREAM_H__
#define __META_X11_SELECTION_INPUT_STREAM_H__
...
void           meta_x11_selection_input_stream_new_async     (MetaX11Display             *display,
                                                              Window                      window,
...
#endif /* __META_X11_SELECTION_INPUT_STREAM_H__ */
