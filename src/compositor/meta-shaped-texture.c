  ...
  if (clip != NULL)
    {
      ...
      *buffer_clip = (MetaRectangle) {
        .x = buffer_clip->x * stex->buffer_scale,
        .y = buffer_clip->y * stex->buffer_scale,
        .width = buffer_clip->width * stex->buffer_scale,
        .height = buffer_clip->height * stex->buffer_scale,
      };
    }
