...
test_pipeline_opengl_blend_enable (void)
{
  ...
  g_assert_cmpint (cogl_context_egl_get_gl_blend_enable_cache (COGL_CONTEXT_EGL (test_ctx)), ==, 0);
  ...
  g_assert_cmpint (cogl_context_egl_get_gl_blend_enable_cache (COGL_CONTEXT_EGL (test_ctx)), ==, 1);
