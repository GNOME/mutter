...
void meta_window_actor_wayland_queue_surface_tree_rebuild (MetaWindowActorWayland *actor);
MetaWindowActorWayland * meta_window_actor_wayland_from_surface (MetaWaylandSurface *surface);
