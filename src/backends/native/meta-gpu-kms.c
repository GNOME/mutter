                   ...
                   void         *user_data)
{
  ...
  int64_t page_flip_time_usec = ((int64_t) sec) * G_USEC_PER_SEC + usec;
  int64_t page_flip_time_nsec = page_flip_time_usec * 1000;

  gpu_kms->last_flip_time_ns = page_flip_time_nsec;
