                        ...
                        float                 new_y)
{
  ...
  clutter_trigger_action_get_threshold_distance (action, &threshold_x, &threshold_y);
  ...
  switch (prop_id)
    ...
    case PROP_THRESHOLD_DISTANCE_X:
      if (self->priv->distance_x > 0.0)
        ...
        g_value_set_float (value, get_default_threshold ());
      break;
 ...
 *
 * Return value: the newly created #ClutterTriggerAction
 *
 * Since: 1.8
 */
ClutterAction *
