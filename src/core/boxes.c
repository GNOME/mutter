...
static gint
compare_rect_areas (gconstpointer a,
                    gconstpointer b)
{
...
gboolean
meta_rectangle_edge_aligns (const MetaRectangle *rect,
                            const MetaEdge      *edge)
{
...
gint
meta_rectangle_edge_cmp_ignore_type (gconstpointer a,
                                     gconstpointer b)
{
...
gint
meta_rectangle_edge_cmp (gconstpointer a,
                         gconstpointer b)
{
  const MetaEdge *a_edge_rect = (gconstpointer) a;
  const MetaEdge *b_edge_rect = (gconstpointer) b;
 ...
 */
static void
fix_up_edges (MetaRectangle *rect,
              MetaEdge      *edge,
              GList        **strut_edges,
              GList        **edge_splits,
