...
/*
 * Returns all damage accumulated since the next buffer was last copied.
 * An empty damage region means that the current source frame is unchanged;
 * an older destination buffer may still need damage from previous frames.
 */
MtkRegion *
