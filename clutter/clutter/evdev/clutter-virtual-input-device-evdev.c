                                          ...
                                          guint                     *level_out)
{
  ...
  // Run through at least once, and that will determine how many loops we check before we give up
  max_num_levels = 1;
  // Traverse lowest levels first, since they're more likely (and keyvals can be listed twice in a keymap)
