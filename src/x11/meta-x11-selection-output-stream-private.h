...
#ifndef __META_X11_SELECTION_OUTPUT_STREAM_H__
#define __META_X11_SELECTION_OUTPUT_STREAM_H__
...
GOutputStream * meta_x11_selection_output_stream_new         (MetaX11Display                *display,
                                                              Window                         window,
...
#endif /* __META_X11_SELECTION_OUTPUT_STREAM_H__ */
