...
with some minor additions such as preferring stdint types to glib
fundamental types, a soft 80 character line limit. However, in general, look at
the file you're editing for inspiration.
