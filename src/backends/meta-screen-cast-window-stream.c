                                               ...
                                               GVariantBuilder      *parameters_builder)
{
  ...
  g_variant_builder_add (parameters_builder, "{sv}",
                         "size",
                         g_variant_new ("(ii)",
                                        window_stream->stream_width,
                                        window_stream->stream_height));
}
                                                   ...
                                                   double               *y)
{
  ...
  *x = CLAMP (window->buffer_rect.x + stream_x,
              window->buffer_rect.x,
              window->buffer_rect.x + window->buffer_rect.width);
  *y = CLAMP (window->buffer_rect.y + stream_y,
              window->buffer_rect.y,
              window->buffer_rect.y + window->buffer_rect.height);
}
