                                    ...
                                    MetaRectangle        *bounds)
{
  ...
  bounds->x = (int) floor ((frame_rect.x - buffer_rect.x) / buffer_scale);
  bounds->y = (int) floor ((frame_rect.y - buffer_rect.y) / buffer_scale);
  bounds->width = (int) ceil (frame_rect.width / buffer_scale);
  bounds->height = (int) ceil (frame_rect.height / buffer_scale);
}
