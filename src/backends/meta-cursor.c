...
get_hardware_cursor_size (uint64_t *cursor_width, uint64_t *cursor_height)
{
  ...
  *cursor_height = 64;
  ...
  if (META_IS_CURSOR_RENDERER_NATIVE (renderer))
    {
      *cursor_width = meta_cursor_renderer_native_get_cursor_width (META_CURSOR_RENDERER_NATIVE (renderer));
      *cursor_height = meta_cursor_renderer_native_get_cursor_height (META_CURSOR_RENDERER_NATIVE (renderer));
    }
#endif
}
