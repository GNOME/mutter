...
static void
meta_input_settings_native_set_mouse_middle_emulation (MetaInputSettings  *settings,
                                                       ClutterInputDevice *device,
                                                       gboolean            enabled)
{
  struct libinput_device *libinput_device;
...
static void
meta_input_settings_native_set_touchpad_middle_emulation (MetaInputSettings  *settings,
                                                          ClutterInputDevice *device,
                                                          gboolean            enabled)
{
  struct libinput_device *libinput_device;
...
static void
meta_input_settings_native_set_trackball_middle_emulation (MetaInputSettings  *settings,
                                                           ClutterInputDevice *device,
                                                           gboolean            enabled)
{
  struct libinput_device *libinput_device;
...
meta_input_settings_native_class_init (MetaInputSettingsNativeClass *klass)
{
  ...
  input_settings_class->set_mouse_middle_emulation = meta_input_settings_native_set_mouse_middle_emulation;
  input_settings_class->set_touchpad_middle_emulation = meta_input_settings_native_set_touchpad_middle_emulation;
  input_settings_class->set_trackball_middle_emulation = meta_input_settings_native_set_trackball_middle_emulation;
