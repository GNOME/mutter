...
dnd_subsurface_sync_actor_state (MetaWaylandActorSurface *actor_surface)
{
  ...
  if (surface_role_dnd->geometry_scale != round (geometry_scale))
    {
...
dnd_surface_calculate_main_logical_monitor (MetaWaylandActorSurface *actor_surface)
{
...
dnd_subsurface_get_geometry_scale (MetaWaylandActorSurface *actor_surface)
{
  if (meta_is_stage_views_scaled ())
  ...
  else
    {
      ...
      logical_monitor =
        dnd_surface_calculate_main_logical_monitor (actor_surface);
