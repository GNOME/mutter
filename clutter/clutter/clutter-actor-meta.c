...
{
  ClutterActorMetaPrivate *priv = clutter_actor_meta_get_instance_private (meta);
...
{
  ClutterActorMetaPrivate *priv = clutter_actor_meta_get_instance_private (CLUTTER_ACTOR_META (gobject));
...
{
  ClutterActorMetaPrivate *priv = clutter_actor_meta_get_instance_private (self);
...
_clutter_actor_meta_get_debug_name (ClutterActorMeta *meta)
{
  ...
  return priv->name != NULL ? priv->name
                                  : G_OBJECT_TYPE_NAME (meta);
}
