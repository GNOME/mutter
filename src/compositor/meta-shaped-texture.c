  ...
  if (stex->has_viewport_dst_size)
    {
      ...
      dst_width = ceilf (stex->viewport_dst_width / tex_scale);
      dst_height = ceilf (stex->viewport_dst_height / tex_scale);
    }
  else if (stex->has_viewport_src_rect)
    {
      ...
      clutter_actor_get_scale (actor, &tex_scale, NULL);
      dst_width = ceilf (stex->viewport_src_rect.size.width / tex_scale);
      dst_height = ceilf (stex->viewport_src_rect.size.height / tex_scale);
    }
  else
    {
