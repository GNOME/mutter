 ...
 * Wayland Support
 *
 * Copyright (C) 2017 Robert Mader <robert.mader@posteo.de>
 *
...
wp_viewport_destructor (struct wl_resource *resource)
{
  ...
  if (surface->viewport.destroy_handler_id > 0)
    {
  ...
  if (surface->viewport.resource)
    {
      ...
      viewport_resource = surface->viewport.resource;
                            ...
                            struct wl_resource *surface_resource)
{
  ...
  surface->viewport.destroy_handler_id =
    g_signal_connect_swapped (surface,
                              "destroy",
                              G_CALLBACK (wp_viewport_destructor),
                              surface_resource);
}
