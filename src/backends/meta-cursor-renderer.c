                                           ...
                                           MetaCursorSprite   *cursor_sprite)
{
  ...
  cursor_is_hidden =
    cursor_sprite &&
    META_IS_CURSOR_SPRITE_XCURSOR (cursor_sprite) &&
    meta_cursor_sprite_xcursor_get_cursor (META_CURSOR_SPRITE_XCURSOR (cursor_sprite)) ==
    META_CURSOR_NONE;
                                    ...
                                    MetaCursorSprite   *cursor_sprite)
{
  ...
  META_CURSOR_RENDERER_GET_CLASS (renderer)->update_cursor (renderer, cursor_sprite);
