...
meta_shaped_texture_dispose (GObject *object)
{
  ...
  cogl_clear_object (&stex->colorspace_conversion);
                            ...
                            CoglMultiPlaneTexture *texture)
{
  ...
  if (stex->colorspace_conversion != NULL)
      return;

  cogl_clear_object (&stex->colorspace_conversion);
  stex->colorspace_conversion = cogl_colorspace_conversion_new (format);
...
meta_shaped_texture_get_texture (MetaShapedTexture *stex)
{
  ...
  return cogl_multi_plane_texture_get_plane (stex->texture, 0);
}
