  ...
  if (vp->buffer.src_width <= 0)
    {
      ...
      src_x = 0.0;
      src_y = 0.0;
      src_width  = (float) cogl_texture_get_width (buffer->texture);
      src_height = (float) cogl_texture_get_height (buffer->texture);
    ...
    if (vp->surface.width == 0)
      {
        surface_width  = (float) cogl_texture_get_width (buffer->texture)  / vp->buffer.scale;
        surface_height = (float) cogl_texture_get_height (buffer->texture) / vp->buffer.scale;
      }
    else
      {
        surface_width  = (float) vp->surface.width;
        surface_height = (float) vp->surface.height;
      }
