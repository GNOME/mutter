...
meta_window_x11_delayed_focus_data_free (MetaWindowX11DelayedFocusData *data)
{
  ...
  g_signal_handler_disconnect (data->display, data->focused_changed_id);
                                     ...
                                     guint32     timestamp)
{
  ...
  data->timeout_id = g_timeout_add (250, focus_window_delayed_timeout, data);
}
