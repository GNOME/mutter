...
struct _MetaInputSettingsClass
{
  ...
  void (* set_mouse_middle_emulation) (MetaInputSettings  *settings,
                                       ClutterInputDevice *device,
                                       gboolean            enabled);
  void (* set_touchpad_middle_emulation) (MetaInputSettings  *settings,
                                          ClutterInputDevice *device,
                                          gboolean            enabled);
  void (* set_trackball_middle_emulation) (MetaInputSettings  *settings,
                                           ClutterInputDevice *device,
                                           gboolean            enabled);
