                                    ...
                                    gint                sync_delay)
{
  ...
  int64_t min_render_time_allowed, max_render_time_allowed;
  ...
  earliest_presentation_time = now + min_render_time_allowed;
  earliest_update_time = earliest_presentation_time - max_render_time_allowed;
