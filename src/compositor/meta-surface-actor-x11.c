...
static void
meta_surface_actor_x11_release_resources (MetaSurfaceActor *actor)
{
  MetaSurfaceActorX11 *self = META_SURFACE_ACTOR_X11 (actor);
...
{
  meta_surface_actor_release_resources (META_SURFACE_ACTOR (object));
...
meta_surface_actor_x11_class_init (MetaSurfaceActorX11Class *klass)
{
  ...
  surface_actor_class->release_resources = meta_surface_actor_x11_release_resources;
}
                         ...
                         gpointer    user_data)
{
  ...
  meta_surface_actor_release_resources (META_SURFACE_ACTOR (self));
  create_damage (self);
}
