                                     ...
                                     int32_t             height)
{
  ...
  /* Don't mark this window as with a new geometry to be applied when neither the position
   * nor the size changed. This avoids calling meta_window_wayland_move_resize(), which is
