...
/**
 * clutter_actor_is_visible_on_stage:
 * @self: a #ClutterActor
 *
 ...
 */
gboolean
clutter_actor_is_visible_on_stage (ClutterActor *self)
{
  ClutterActor *actor;
 ...
 * Since: 1.24
 *
 * Deprecated: N.NN: Directly replaced by clutter_actor_is_visible_to_parent()
 *                   for greater clarity. But see also
 *                   clutter_actor_is_visible_on_stage().
 */
gboolean
