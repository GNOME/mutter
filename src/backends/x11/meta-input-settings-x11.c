...
static void
meta_input_settings_x11_set_mouse_middle_emulation (MetaInputSettings  *settings,
                                              ClutterInputDevice *device,
                                              gboolean            enabled)
{
  guchar value = enabled ? 1 : 0;
...
static void
meta_input_settings_x11_set_touchpad_middle_emulation (MetaInputSettings  *settings,
                                                       ClutterInputDevice *device,
                                                       gboolean            enabled)
{
  guchar value = enabled ? 1 : 0;
...
static void
meta_input_settings_x11_set_trackball_middle_emulation (MetaInputSettings  *settings,
                                                        ClutterInputDevice *device,
                                                        gboolean            enabled)
{
  guchar value = enabled ? 1 : 0;
...
meta_input_settings_x11_class_init (MetaInputSettingsX11Class *klass)
{
  ...
  input_settings_class->set_mouse_middle_emulation = meta_input_settings_x11_set_mouse_middle_emulation;
  input_settings_class->set_touchpad_middle_emulation = meta_input_settings_x11_set_touchpad_middle_emulation;
  input_settings_class->set_trackball_middle_emulation = meta_input_settings_x11_set_trackball_middle_emulation;
