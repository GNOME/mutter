                  ...
                  gboolean            swap_with_damage)
{
  ...
  damage = g_newa (int, ndamage);
  memmove (damage, swap_region, ndamage);
      ...
      for (i = 0; i < n_rects; i++)
        {
          ...
          cairo_region_get_rectangle (redraw_clip, i, &new_fb_clip_rect);
          _clutter_util_rect_from_rectangle (&new_fb_clip_rect, &rect);
              ...
              for (i = 0; i < n_rects; i++)
                {
                  ...
                  cairo_region_get_rectangle (fb_clip_region, i, &damage_rect);
                  _clutter_util_rect_from_rectangle (&damage_rect, &rect);
                  scale_and_clamp_rect (&rect, 1.0f / fb_scale, &damage_rect);
                  _clutter_util_rectangle_offset (&damage_rect,
                                                  view_rect.x,
                                                  view_rect.y,
                                                  &damage_rect);
