...
cairo_region_t *    meta_wayland_surface_surface_to_buffer (MetaWaylandSurface *surface,
                                                            cairo_region_t *region);

guint               meta_wayland_surface_get_width (MetaWaylandSurface *surface);
guint               meta_wayland_surface_get_height (MetaWaylandSurface *surface);
guint               meta_wayland_surface_get_pending_width (MetaWaylandSurface *surface);
guint               meta_wayland_surface_get_pending_height (MetaWaylandSurface *surface);
