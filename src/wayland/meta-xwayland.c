                   ...
                   MetaXWaylandManager *manager)
{
  ...
  if (!window->xwindow ||
      window->xwindow == display->x11_display->leader_window ||
      window->xwindow == display->x11_display->wm_cm_selection_window ||
      window->xwindow == display->x11_display->guard_window ||
      window->xwindow == display->x11_display->timestamp_pinging_window ||
      window->xwindow == display->x11_display->no_focus_window ||
